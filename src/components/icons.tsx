...
// Inline SVG icon set — keeps the bundle dependency-free and styles via
// currentColor. Stroke icons use a 24×24 viewBox.
...
const ICONS = {
  ...
  'star-filled': <path d="M12 2l3 6.3 6.9 1-5 4.9 1.2 6.9L12 18.8 5.9 21l1.2-6.9-5-4.9 6.9-1z" />,
  phone: (
  ...
  alert: (
    <>
      <path d="m21.7 18-9-15.5a2 2 0 0 0-3.4 0L.3 18a2 2 0 0 0 1.7 3h18a2 2 0 0 0 1.7-3z" />
  ...
  pathophysiology: (
    <>
      ...
      <path d="M7 7.5 10.5 16M17 7.5 13.5 16M7 6h10" />
    </>
  ),
  redflags: (
    <>
...
const FILLED = new Set<IconName>(['star-filled']);
